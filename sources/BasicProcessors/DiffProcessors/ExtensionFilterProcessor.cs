...
namespace BasicProcessors.DiffProcessors
{
    ...
    {
        /// <summary>
        /// Enum of available file types.
        /// 
        /// Every file type has a predefined array of extensions.
        /// </summary>
        public enum FileTypesEnum { All, Image, Text, Developer }

        /// <summary>
        /// Filtering depending on a file type.
        /// </summary>
        [Settings("Filter files by extension category.", "extension-category")]
        public FileTypesEnum FileType = FileTypesEnum.All;

        /// <summary>
        /// Common extensions for image files.
        /// </summary>
        ...
        /// <summary>
        /// Common extensions for text files.
        /// </summary>
        ...
        /// <summary>
        /// Common extensions for files used by developers.
        /// </summary>
        ...
        protected override void ProcessChecked(INodeFileNode node)
        {
            ...
            // filter by mode
            if (FileType == FileTypesEnum.Image && Array.BinarySearch(imagesExtensions, ext) < 0)
            {
                node.Status = NodeStatusEnum.IsIgnored;
